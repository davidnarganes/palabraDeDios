...
window_size = 50 # number of characters for prediction
overlap = 1 # overlaping between sentences
batch_size = 20 # batch size
num_epochs = 40 # number of epochs
steps_epoch = len(biblia_inds) // (window_size*batch_size)
save_freq = 1
...
verse_generator = batchGenerator(biblia_inds, window_size, overlap, batch_size)
