...
callbacks = [LambdaCallback(on_epoch_end=on_epoch_end), \
            ...
            ModelCheckpoint(filepath=save_dir + "/" + 'deep_model_biblia.{epoch:02d}-{val_loss:.2f}.hdf5', monitor='loss', verbose=0, mode='auto', period=10)]
...
# model = load_model("C://Users//Sísifo//Documents//GitHub//palabraDeDios//data//models//keras_guillermo//modelo_biblia.70-2.21.hdf5")
